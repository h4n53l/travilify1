...
export const carTypeData =[
    {title:"Popular",
     data:[
    {name:"Travilify Go",group :2, price:7,image: require('../../assets/uberGo.png'),note:"Affordable.compact rides",promotion:5 ,time:"20:19",id:"0"},
    {name:"Travilify",group :3, price:5.5,image: require('../../assets/uberX.png'),note:"Affordable everyday trips",promotion:0,time:"20:20", id:"1"},
...
export const availableServices = ["Travilify Go","Travilify","Travilify connect","Travilify Black","Travilify Van","Travilify Assist"]

export const carsAround = [{latitude:-26.207487,longitude:28.236226},
    {latitude:50.7371737,longitude:-1.8588705},
